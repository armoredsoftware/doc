...
\begin{figure}
\centering 
\subfigure[Attestation Processing]{\includegraphics[width=0.450\textwidth]{figures/ap-1.pdf}\label{fig:ap-1}}
\subfigure[Evidence Processing]{\includegraphics[width=0.450\textwidth]{figures/ap-2.pdf}\label{fig:ap-2}}
