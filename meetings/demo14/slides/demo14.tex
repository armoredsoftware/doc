...
\begin{frame}
  ...
  \framesubtitle{Cloud-based trust infrastructure}
  \begin{itemize}
...
\begin{frame}
  ...
  \begin{columns}[c]
    ...
    \item Support for new and legacy software
...
\begin{frame}[fragile]
  \frametitle{Requesting an Attestation}
  \begin{center}
    \begin{tikzpicture}[
      implies/.style={double,double equal sign distance,-implies},
      dot/.style={shape=circle,fill=black,minimum size=4pt,
...
\begin{frame}[fragile]
  \frametitle{Gathering Measurements}
