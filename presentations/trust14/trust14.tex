...
\frame{\frametitle{Chaining Measurements}
    ...
    \column{.53\textwidth}
    \begin{itemize}
    \item<1-> Start with a measurer and store that are trusted
      \emph{a priori}
...
\frame{\frametitle{What Do We Know?}
  ...
  Assume we know $\extend{\extend{0}{\hash{A}}}{\hash{B}}$ is correct
...
\frame{\frametitle{Trust is a Preorder}
  ...
  \alert{Measured Boot gathers evidence supporting these chains}
}
