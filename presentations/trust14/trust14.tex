...
\frame{\frametitle{Capabilities for Establishing Trust}
  \begin{itemize}
...
\frame{\frametitle{Tools for Trust}
  ...
  \item $\hash{X}$ --- Hash function such as MD-5
    ...
    \end{itemize}
  \item $\encrypt{X}{Y}$ --- Encrypt $X$ with $Y$
    \begin{itemize}
    ...
    \end{itemize}
  \item $\sign{X}{Y}$ --- Sign $X$ with $Y$
    \begin{itemize}
    \item $\sign{X}{Y}$ is unique for every $X$ and $Y$ pair
