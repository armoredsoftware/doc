...
\frame{\frametitle{Chaining Measurements}
    ...
    \column{.53\textwidth}
    \begin{itemize}
    \item<1-> Start with a measurer and store that is trusted
    \item<2-> Measure software to be launched
    \item<3-> Store the measurement
    \item<4-> Launch the new software
    \item<5-> Repeat until system boot
    \end{itemize}
    \column{.45\textwidth}
    \begin{figure}
