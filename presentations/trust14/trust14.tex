...
\frame{\frametitle{Root of Trust for Measurement}
  ...
  \item In the Intel TXT process the RTM is \textsf{SENTER} implemented on the processor
  \item \textsf{SENTER} resets and measures \textsf{SINIT} into PCR 18
    in the TPM\footnote{`Measures X into PCR Y' informally means
      extending PCR Y with a hash of X.}
  \item SENTER runs securely in the Intel processor~\footnote{AMD has
